...
import DootApplication from '../models/DootApplication.js'

const EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/

// Public — the Mzobs Doot application form on the landing site.
export const submitApplication = asyncHandler(async (req, res) => {
  ...
  const application = await DootApplication.create(data)
