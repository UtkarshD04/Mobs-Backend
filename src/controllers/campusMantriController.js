...
import CampusMantriApplication from '../models/CampusMantriApplication.js'

const EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/

// Public — the Campus Mantri application form on the landing site.
export const submitApplication = asyncHandler(async (req, res) => {
  ...
  const application = await CampusMantriApplication.create(data)
